...
class PropertyInsurance extends StatefulWidget {
  const PropertyInsurance({Key? key}) : super(key: key);

  @override
  State<PropertyInsurance> createState() => PropertyInsuranceState();
}

class PropertyInsuranceState extends State<PropertyInsurance> {
  @override
  void initState() {
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child:Image.asset("assets/propertyLoan.png",fit: BoxFit.fitWidth,),
                  ),
                ),
              ),
              Padding(
                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child:   Row(
                          children: [
                            Text("Property Insurance",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16.w),),
                          ],
                        ),
                      ),
                      Padding(
