...
class CorporateAccount extends StatefulWidget {
  const CorporateAccount({Key? key}) : super(key: key);
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child:Image.asset("assets/corporateAccount.png",fit: BoxFit.fitWidth,),
                  ),
                ),
              ),
              Padding(
                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child:   Row(
                          children: [
                            Text("Salary Account",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16.w),),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Padding(
                          ...
                          child: Flex(
                            ...
                            children: [
                              Expanded(
                                child: ReadMoreText(
                                  "Watch your savings grow with our attractive interest rates. "
                                      "Earn interest on your account balance, allowing your money "
                                      "to work harder for you and accumulate over time.  Enjoy the"
                                      " flexibility of a savings account with no minimum balance requirement. "
                                      "Start saving with any amount you prefer and manage your finances without"
                                      " the stress of maintaining a minimum balance.",
                                  trimLines: 15,
