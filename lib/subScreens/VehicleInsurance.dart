...
class VehicleInsurance extends StatefulWidget {
  ...
  @override
  State<VehicleInsurance> createState() => VehicleInsuranceState();
}

class VehicleInsuranceState extends State<VehicleInsurance> {
  @override
  void initState() {
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child:  Image.asset("assets/travelInsurance.png",fit: BoxFit.fitWidth,),
                  ),
                ),
              ),
              Padding(
                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child:   Row(
                          children: [
                            Text("Vehicle Insurance",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16.w),),
                          ],
                        ),
                      ),
                      Padding(
