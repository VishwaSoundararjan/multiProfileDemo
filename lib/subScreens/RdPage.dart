...
class RdPage extends StatefulWidget {
  ...
  @override
  State<RdPage> createState() => RdPageState();
}

class RdPageState extends State<RdPage> {
  @override
  void initState() {
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child:Image.asset("assets/rdImg.png",fit: BoxFit.fitWidth,),
                  ),
                ),
              ),
              Padding(
                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child:   Row(
                          children: [
                            Text("Regular Recurrent Deposit",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16.w),),
                          ],
                        ),
                      ),
                      Padding(
