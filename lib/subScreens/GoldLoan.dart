...
class GoldLoanPage extends StatefulWidget {
  const GoldLoanPage({Key? key}) : super(key: key);

  @override
  State<GoldLoanPage> createState() => _GoldLoanPageState();
}

class _GoldLoanPageState extends State<GoldLoanPage> {
  @override
  void initState() {
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child:Image.asset("assets/goldLoanImg.png",fit: BoxFit.fitWidth,),
                  ),
                ),
              ),
              Padding(
                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child:   Row(
                          children: [
                            Text("Gold Loan",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16.w),),
                          ],
                        ),
                      ),
                      Padding(
