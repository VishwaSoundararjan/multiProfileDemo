...
class TravelInsurance extends StatefulWidget {
  ...
  @override
  State<TravelInsurance> createState() => TravelInsuranceState();
}

class TravelInsuranceState extends State<TravelInsurance> {
  @override
  void initState() {
                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child:   Row(
                          children: [
                            Text("Travel Insurance",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16.w),),
                          ],
                        ),
                      ),
                      Padding(
