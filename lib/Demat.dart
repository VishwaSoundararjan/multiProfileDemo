...
class DematAccount extends StatefulWidget {
  const DematAccount({Key? key}) : super(key: key);
...
class _DematAccountState extends State<DematAccount> {
  var dematPageData=DataClass.dematPageData;
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body:
        Container(
          child: dematPageData!=null?Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        GridViewWidget(ads_list: this.dematPageData),
                      ],
                    ),
                  ),
                ],
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Image.asset("assets/joint-account.png",height: 100.h,width: 100.w,),
                  ],
                ),
              ),
            ),
