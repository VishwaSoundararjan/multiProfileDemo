...
import ioo.mob.resuu.reandroidsdk.error.Util;
...
public class EnableFieldCapture /*extends AsyncTask<String, String, JSONObject> */ {
                    ...
                    for (JSONObject id : captureIds) {
                        try {
                            ...
                            if (view1 != null) {
                                ...
                                if (!ioo.mob.resuu.reandroidsdk.error.Util.isButton(view1)) {
    ...
    private void setValues(JSONObject values, View view) {
        ...
        try {
            ...
            if (ioo.mob.resuu.reandroidsdk.error.Util.isTextView(view)) {
                TextView v1 = (TextView) view;
                v1.setText(result);
            } else if (ioo.mob.resuu.reandroidsdk.error.Util.isButton(view)) {
                Button v1 = (Button) view;
                v1.setText(result);
            } else if (ioo.mob.resuu.reandroidsdk.error.Util.isEditText(view)) {
                EditText v1 = (EditText) view;
                v1.setText(result);
            } else if (ioo.mob.resuu.reandroidsdk.error.Util.isToggleButton(view)) {
                ToggleButton v1 = (ToggleButton) view;
                v1.setText(result);
            } else if (ioo.mob.resuu.reandroidsdk.error.Util.isCheckBox(view)) {
                CheckBox v1 = (CheckBox) view;
                v1.setText(result);
            } else if (ioo.mob.resuu.reandroidsdk.error.Util.isRadioButton(view)) {
                RadioButton v1 = (RadioButton) view;
                v1.setText(result);
            } else if (ioo.mob.resuu.reandroidsdk.error.Util.isImageView(view)) {
