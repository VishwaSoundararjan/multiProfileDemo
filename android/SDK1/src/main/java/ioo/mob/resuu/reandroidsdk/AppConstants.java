...
public class AppConstants {
   ...
   /* static final String baseUrl = "https://mob.smartdx.co/Home/";
    static final String FirstBaseUrl = "https://mob.smartdx.co/Home/";
    static final String socketLiveDashboard = "https://lsoc.resu.io";
    static final String socketUrl = "https://mobsoc.resu.io/";*/

    public static String LAST_ACTIVITY_NAME = "";
    public static String LAST_FRAGMENT_NAME = "";
    public static String APP_CURRENT_EVENT = "";
    ...
    */
    ...
    public static String hybridScreenShot = "";
    ...
    static boolean APP_LIVE_DASHBOARD = true;
    ...
    public static boolean IsVisit = true;
    public static boolean IsSession = true;
    static HashMap<String, JSONObject> CustomEvents = new HashMap<String, JSONObject>();
    static HashMap<String, JSONObject> CustomEventsData = new HashMap<String, JSONObject>();
