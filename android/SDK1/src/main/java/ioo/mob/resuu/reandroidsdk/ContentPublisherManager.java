...
public class ContentPublisherManager {
    ...
    private void initializeViews(JSONObject content, View container) {
        ...
        try {
            ...
            } else if (content.getString("type").equals("textview") && ioo.mob.resuu.reandroidsdk.error.Util.isTextView(container)) {
            ...
            } else if (content.getString("type").equals("button") && ioo.mob.resuu.reandroidsdk.error.Util.isButton(container)) {
            ...
            } else if (content.getString("type").equals("imageview") && ioo.mob.resuu.reandroidsdk.error.Util.isImageView(container)) {
