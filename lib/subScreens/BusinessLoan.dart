              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.asset("assets/businessLoan.png",fit: BoxFit.fitWidth,),
                  ),
                ),
              ),
              Padding(
                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child:   Row(
                          children: [
                            Text("Business Loan",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16.w),),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Padding(
                          ...
                          child: Flex(
                            ...
                            children: [
                              Expanded(
                                child: ReadMoreText(
                                      "Say goodbye to lengthy paperwork and long waiting times. "
                                      "Our app offers a streamlined and user-friendly application process, "
                                      "allowing you to apply for a business loan within minutes, saving you "
                                      "valuable time and effort. Tailor your loan amount to suit your business "
                                      "needs. Whether you require funds for working capital, expansion, inventory, "
                                      "or equipment, our app provides flexible loan options that can be customized"
