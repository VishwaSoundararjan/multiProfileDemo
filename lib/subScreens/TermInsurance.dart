...
class TermInsurance extends StatefulWidget {
  const TermInsurance({Key? key}) : super(key: key);

  @override
  State<TermInsurance> createState() => TermInsuranceState();
}

class TermInsuranceState extends State<TermInsurance> {
  @override
  void initState() {
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child:Image.asset("assets/termInsurance.png",fit: BoxFit.fitWidth,),
                  ),
                ),
              ),
              Padding(
                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child:   Row(
                          children: [
                            Text("Term Insurance",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16.w),),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Padding(
                          ...
                          child: Flex(
                            ...
                            children: [
                              Expanded(
                                child: ReadMoreText(
                                  "Safeguard the financial future of your loved ones with our term "
                                      "insurance plans. Ensure that they are well-protected and "
                                      "financially secure in case of any unfortunate event. Enjoy "
                                      "the benefit of affordable premiums with our term insurance "
                                      "policies. Protect your family's future without straining your budget,"
                                      " as term insurance offers substantial coverage at a reasonable cost",
                                  trimLines: 15,
