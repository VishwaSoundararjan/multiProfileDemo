                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child:   Row(
                          children: [
                            Text("Book Tickets",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16.w),),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Padding(
                          ...
                          child: Flex(
                            ...
                            children: [
                              Expanded(
                                child: ReadMoreText(
                                  "Get up-to-date information on ticket availability in real-time. Our app "
                                      "connects directly with ticketing systems, ensuring that you have the "
                                      "latest information at your fingertips, helping you secure your preferred "
                                      "seats and dates.Choose your preferred seats with interactive seat maps. "
                                      "Get a virtual view of the venue or aircraft layout, enabling you to select"
                                      " the best seats based on your preferences and requirements.",
                                  trimLines: 15,
