              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.asset("assets/fixeddeposit.png",fit: BoxFit.fitWidth,),
                  ),
                ),
              ),
              Padding(
                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child:   Row(
                          children: [
                            Text("Current Account",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16.w),),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Padding(
                          ...
                          child: Flex(
                            ...
                            children: [
                              Expanded(
                                child: ReadMoreText(
                                      "Our current account is designed to meet the unique needs of businesses. "
                                      "Benefit from a range of business-focused features and services tailored"
                                      " to support your financial operations.  Streamline your cash flow management"
                                      " with our current account. Separate your business finances from personal funds,"
                                      " enabling better tracking, budgeting, and financial planning.",
                                  trimLines: 15,
