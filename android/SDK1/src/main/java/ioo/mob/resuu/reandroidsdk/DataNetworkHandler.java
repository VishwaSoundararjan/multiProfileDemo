...
import static ioo.mob.resuu.reandroidsdk.AppConstants.CAMPAIGN_BLAST_API;
import static ioo.mob.resuu.reandroidsdk.AppConstants.CUSTOM_EVENT;
import static ioo.mob.resuu.reandroidsdk.AppConstants.FORM_API;
import static ioo.mob.resuu.reandroidsdk.AppConstants.FirstBaseUrl;
import static ioo.mob.resuu.reandroidsdk.AppConstants.LOCATION_TRACKING;
import static ioo.mob.resuu.reandroidsdk.AppConstants.SCREEN_TRACKING;
import static ioo.mob.resuu.reandroidsdk.AppConstants.SDK_TOKEN_UPDATE;
import static ioo.mob.resuu.reandroidsdk.AppConstants.baseUrl;
import static ioo.mob.resuu.reandroidsdk.AppConstants.deviceId;
import static ioo.mob.resuu.reandroidsdk.AppConstants.isLogin;
import static ioo.mob.resuu.reandroidsdk.AppConstants.licence;
import static ioo.mob.resuu.reandroidsdk.AppConstants.retryCount;
        ...
        try {
            ...
            executor.execute(() -> {
                ...
                try {
                    ...
                    handler.post(() -> {
                        new DataExchanger("GetSDKRules", finalJsonObject.toString(), this, AppConstants.SDK_RULES).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, "");
                    });
                } catch (Exception e) {
...
*/
    ...
    private class DBCheck /*extends AsyncTask<Boolean, Boolean, Boolean>*/ {
        ...
        private Boolean doInBackground(Boolean... urls) {
            try {
    ...
    private class BackgroundProcess /*extends AsyncTask<Integer, Integer, Integer> */ {
        ...
        void executeOnExecutor(Executor executors, int obj) {
            try {
                ExecutorService executor = Executors.newSingleThreadExecutor();
                executor.execute(() -> {
                    try {
        ...
        private void doInBackground(Integer... strings) {
            try {
                JSONObject jsonObject;
...
/*
                                "identifier": "502",
                                        "captureType": "Value",
                                        "screenName": "ApplicationFormViewController",
                                        "formId": "10",
                                        "result": "1234567890",
                                        "formName": "Sample",
                                        "fieldName": "Phone",
                                ...
                                obj1.put("identifier","tv_scan");
                                obj1.put("screenName","DashboardFragment");
                                obj1.put("captureType","Click");
                                JSONObject obj2 = new JSONObject();
                                obj2.put("identifier","tv_add_payee");
                                obj2.put("screenName","DashboardFragment");
                                obj2.put("captureType","Click");
