                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child:   Row(
                          children: [
                            Text("Recharge",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16.w),),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Padding(
                          ...
                          child: Flex(
                            ...
                            children: [
                              Expanded(
                                child: ReadMoreText(
                                      "Say goodbye to long queues and time-consuming processes. Our"
                                      " user-friendly app provides a seamless recharge experience, allowing"
                                      " you to recharge your services anytime and from anywhere. In today's "
                                      "fast-paced world, staying connected is essential. With our online recharge"
                                      " services, you can conveniently recharge your mobile, DTH, or other utility "
