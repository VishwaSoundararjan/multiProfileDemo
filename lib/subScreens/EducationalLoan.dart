...
class EducationalLoan extends StatefulWidget {
  const EducationalLoan({Key? key}) : super(key: key);

  @override
  State<EducationalLoan> createState() => EducationalLoanState();
}

class EducationalLoanState extends State<EducationalLoan> {
  @override
  void initState() {
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child:Image.asset("assets/edu_loan.JPEG",fit: BoxFit.fitWidth,),
                  ),
                ),
              ),
              Padding(
                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child:   Row(
                          children: [
                            Text("Educational Loan",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16.w),),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Padding(
                          ...
                          child: Flex(
                            ...
                            children: [
                              Expanded(
                                child: ReadMoreText(
                                     " Say goodbye to complicated loan applications. Our app offers a simple and "
                                      "user-friendly interface, making it easy to apply for an educational loan. "
                                      "Submit your application within minutes, saving you time and effort.  Pursue"
                                      " your dreams at your preferred educational institution. Whether it's a university, "
                                      "college, or vocational school, our app provides educational loan options for various "
                                      "types of institutions, ensuring that you have access to quality education",
                                  trimLines: 15,
