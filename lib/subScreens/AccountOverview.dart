...
class AccountOverview extends StatefulWidget {
  ...
  @override
  State<AccountOverview> createState() => AccountOverviewState();
}

class AccountOverviewState extends State<AccountOverview> {
  ...
  var accountPageData=DataClass.accountPageData;
  @override
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child:Image.asset("assets/acc_overview.png",fit: BoxFit.fitWidth,),
                  ),
                ),
              ),
              Padding(
                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child:   Row(
                          children: [
                            Text("Account Overview",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16.w),),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Padding(
                          ...
                          child: Flex(
                            ...
                            children: [
                              Expanded(
                                child: ReadMoreText(
                                  " Experience the convenience of instant gold evaluation using our app. "
                                      "Simply provide basic details about your gold items, and our advanced "
                                      "algorithms will determine their value, allowing you to access quick loans"
                                      " against your gold. Say goodbye to lengthy paperwork and lengthy approval "
                                      "processes. Our app streamlines the gold loan process, ensuring a seamless"
                                      " and hassle-free experience. Apply for a loan in minutes and receive instant approval,"
                                      " getting access to funds when you need them the most.",
                                  trimLines: 15,
